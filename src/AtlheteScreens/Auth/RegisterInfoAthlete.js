...
export default class RegisterInfoAthlete extends React.Component {
  constructor(props) {
    super(props);
            ...
            <Formik
              initialValues={{
               ...
               validationSchema = {Yup.object().shape({
                ...
                confirm_password:Yup.string().oneOf([Yup.ref('password'), null], 'Les mots de passe saisis ne sont pas identiques.')
