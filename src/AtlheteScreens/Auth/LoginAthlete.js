...
import {View, SafeAreaView,StyleSheet,Dimensions, Image,TextInput,Text, TouchableOpacity} from 'react-native'
...
export default class LoginAthlete extends React.Component {
  ...
  async onLoginPress(values) {
   // const {email, password}=values;
    const {email, password}={email:"blakos972@yahoo.fr", password:"a"};
