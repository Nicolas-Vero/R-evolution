...
const TreshRequestCoachScreenView = ({ state, controller }) => {
  const {
    Athlete,
    isLoaded,
    dialogVisible,
    ...
    <View style={styles.container}>
      <SafeAreaView>
        <TreshRequestDialog
          ...
          onNavigateToUserSheet={controller.onNavigateToUserSheet}
        />
        ...
        <ScrollView style={styles.scrollView}>
          ...
          <View style={styles.button}>
            <Button
              ...
              onPress={controller.onOpenDialog}
            />
          </View>
        </ScrollView>
      </SafeAreaView>
...
export default TreshRequestCoachScreenView;
