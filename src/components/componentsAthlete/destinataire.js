              ...
              <View style={{ paddingLeft: 16, paddingRight: 16, flex: 1 }}>
                <Formik
                  ...
                  validationSchema={Yup.object().shape({
                    coach_preference: Yup.object().required('Si vous n\'avez pas de preférence selectionner peu importe'),
                  })}>
                  {({
                    handleChange,
                    handleBlur,
                   ...
                   <View>
                        ...
                        <View
                          style={{
                            ...
                            marginBottom: 24,
                            borderWidth:
                            errors.coach_preference && touched.coach_preference ? 2 : 0,
                          borderColor:
                            errors.coach_preference && touched.coach_preference
                              ? 'red'
                              : null,
                          }}>
                          <CheckBox
