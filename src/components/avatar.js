      ...
      {({
        ...
        return (
          ...
          <SafeAreaView >
            ...
            { image? (<Text  style={{ fontWeight: 'bold', fontSize: 17, color: '#FFFF' }}>Superbe photo !</Text>):(<Text  style={{ fontWeight: 'bold', fontSize: 17, color: '#FFFF',textAlign:'center' }}>C'est toujours plus professionnel avec une photo de profil</Text>)}
              </View>
            </View>
